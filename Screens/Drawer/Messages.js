        ...
        <View style={styles.container}>
            <View style={styles.messageContainer}>
                <View style={styles.messagesHeader}>
                    ...
                    <Text style={styles.ChatHeaderName}>Yash Salave</Text>
                </View>
                <ScrollView contentContainerStyle={styles.scrollViewContent}>
                    <View style={styles.messagesMe}>
                    <Text numberOfLines={10} style={[styles.messageMeBox, {textAlign: 'right'}]}>ok</Text>
                        <Image source={require('../Assets/04.jpg')} style={styles.imageContainer} />
                    </View>
                    ...
                    <View style={styles.messagesFriend}>
                        <Image source={require('../Assets/04.jpg')} style={styles.imageContainer} />
                        <Text numberOfLines={10} style={[styles.messageFriendBox, {textAlign: 'left'}]}>o</Text>
                    ...
                    <View style={styles.messagesFriend}>
                        ...
                        <Text numberOfLines={10} style={[styles.messageFriendBox,]}>
      How Are You How Are You How Are You How Are You How Are You How Are You How Are You How Are You How Are You How Are You You How Are You You How Are You You How Are You
    </Text>
                        <Text style={styles.timeFriend}>10:20 AM</Text>
                    </View>
